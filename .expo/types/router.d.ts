...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(modal)/basket` | `/basket` | `/(modal)/details` | `/details` | `/(modal)/dish` | `/dish` | `/(modal)/filter` | `/filter` | `/(modal)/location-search` | `/location-search` | `/(modal)/login` | `/login` | `/(modal)/register` | `/register` | `/_layout`;
  // prettier-ignore
